...
export declare const fetchHassioBackupInfo: (hass: HomeAssistant, backup: string) => Promise<HassioBackupDetail>;
...
export declare const restoreBackup: (hass: HomeAssistant, type: HassioBackupDetail["type"], backupSlug: string, backupDetails: HassioPartialBackupCreateParams | HassioFullBackupCreateParams, useBackupUrl: boolean) => Promise<void>;
export {};
