...
export declare const computeStateToParts: (localize: LocalizeFunc, stateObj: HassEntity, locale: FrontendLocaleData, sensorNumericDeviceClasses: string[], config: HassConfig, entities: HomeAssistant["entities"], state?: string) => ValuePart[];
