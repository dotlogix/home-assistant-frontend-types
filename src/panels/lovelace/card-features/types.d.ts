...
export declare const MEDIA_PLAYER_PLAYBACK_CONTROLS: readonly ["turn_on", "turn_off", "media_play", "media_pause", "media_play_pause", "media_stop", "media_previous_track", "media_next_track"];
export type MediaPlayerPlaybackControl = (typeof MEDIA_PLAYER_PLAYBACK_CONTROLS)[number];
